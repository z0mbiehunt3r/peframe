...
def get(pe):
    ...
    dir_tls = pe.OPTIONAL_HEADER.DATA_DIRECTORY[
    ...
    dir_resource = pe.OPTIONAL_HEADER.DATA_DIRECTORY[pefile.DIRECTORY_ENTRY[
        'IMAGE_DIRECTORY_ENTRY_RESOURCE']].VirtualAddress
    # PointerToRelocations, NumberOfRelocations, NumberOfLinenumbers
    dir_relocation = pe.OPTIONAL_HEADER.DATA_DIRECTORY[pefile.DIRECTORY_ENTRY[
        'IMAGE_DIRECTORY_ENTRY_BASERELOC']].VirtualAddress
    # PointerToRelocations, NumberOfRelocations, NumberOfLinenumbers
    dir_security = pe.OPTIONAL_HEADER.DATA_DIRECTORY[pefile.DIRECTORY_ENTRY[
